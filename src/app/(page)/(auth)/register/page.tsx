...
export default function RegisterPage() {
  ...
  try {
    ...
    // Handle response berdasarkan provider dan requireLogin flag
    if (data.requireLogin) {
      // Untuk registrasi manual - user perlu login
      showSuccess(
      ...
      // Untuk Google OAuth atau kasus lain dimana user langsung login
      showSuccess(
        "Pendaftaran Berhasil!",
        "Akun Anda berhasil dibuat dan Anda sudah login.",
  ...
  const handleGoogleSignUp = async () => {
    try {
      ...
      window.location.href = "/api/auth/google?state=register";
    } catch (error) {
      ...
      <div className="relative max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg">
            Bergabunglah untuk memulai perjalanan karier berkelanjutan
          </p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl p-8 border border-white/50">
          <form className="space-y-6" onSubmit={handleSubmit}>
            {/* Error Messages */}
            {errors.general && (
              <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-2xl text-sm flex items-start">
                <svg
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  disabled={isLoading || isSuccess}
                  className={`w-full px-4 py-3 border-2 text-black rounded-2xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-300 bg-white/50 backdrop-blur-sm pr-12 ${
                    errors.password
                      ? "border-red-300"
                      : "border-gray-200 hover:border-emerald-300"
                  } ${
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  disabled={isLoading || isSuccess}
                  className={`w-full px-4 py-3 border-2 rounded-2xl text-black focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-300 bg-white/50 backdrop-blur-sm pr-12 ${
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 gap-4">
              <button
                ...
                disabled={isLoading || isSuccess}
                className="w-full inline-flex justify-center py-3 px-4 border border-gray-200 rounded-2xl shadow-sm bg-white/70 backdrop-blur-sm text-sm font-medium text-gray-700 hover:bg-white/90 hover:shadow-md transition-all duration-300 transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              >
